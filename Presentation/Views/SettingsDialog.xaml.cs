    ...
    public partial class SettingsDialog : Window
    {
        ...
        private async void BtnRenameDbFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (newPath != null)
                {
                    await App.DialogService.ShowInfoAsync("SettingsDialogHost", $"Archivo renombrado a:\n{newPath}", "Renombrar archivo");
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido renombrar el archivo:\n{ex.Message}");
            }
        }
        ...
        private async void BtnSwitchDatabase_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido abrir esa colección:\n{ex.Message}");
            }
        }
        ...
        private async void BtnBackup_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                await App.DialogService.ShowInfoAsync("SettingsDialogHost", $"Copia de seguridad guardada en:\n{dlg.FileName}", "Guardar copia de seguridad");
            }
            catch (Exception ex)
            {
                LoggingService.LogError("Guardar copia de seguridad", ex);
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido guardar la copia de seguridad:\n{ex.Message}");
            }
        }
        ...
        private async void BtnVacuum_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido compactar la base de datos:\n{ex.Message}");
            }
        }
