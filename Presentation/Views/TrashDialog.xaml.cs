    ...
    public partial class TrashDialog : Window
    {
        ...
        private async void BtnRestore_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("TrashDialogHost", $"No se ha podido restaurar el juego:\n{ex.Message}");
            }
        }
        ...
        private async void BtnDeleteForever_Click(object sender, RoutedEventArgs e)
        {
            ...
            var confirmed = await App.DialogService.ShowConfirmAsync("TrashDialogHost",
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("TrashDialogHost", $"No se ha podido eliminar el juego:\n{ex.Message}");
            }
        }
        ...
        private async void BtnEmptyTrash_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("TrashDialogHost", $"No se ha podido vaciar la papelera:\n{ex.Message}");
            }
        }
